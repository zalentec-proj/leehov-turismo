...
export default async function NewCaravanPage() {
  ...
  return <div><p className="text-xs font-bold uppercase tracking-[0.18em] text-leehov-blue-600">Pacotes</p><h2 className="mb-8 mt-3 text-3xl font-extrabold text-leehov-navy-950">Novo pacote</h2><CaravanForm categories={categories} /></div>;
}
