...
export default async function AdminTestimonialsPage() {
  const { profile, permissions } = await requirePermission("testimonials.view");
  ...
  const safeSettings = permissions.includes("testimonials.manage_google") ? settings : { ...settings, accountId: "", locationId: "", connection: null };
