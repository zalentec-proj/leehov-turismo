...
export default async function AdminNewsletterPage() {
  const [subscribers, logs, metrics, campaigns, media, profile] = await Promise.all([getAdminNewsletterSubscribers(), getEmailLogs(), getNewsletterMetrics(), getAdminNewsletterCampaigns(), getMediaAssetOptions(), requireActiveProfile()]);
  const cards = [
