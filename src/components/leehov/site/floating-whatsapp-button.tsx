...
export function FloatingWhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-[84px] right-4 z-50 flex size-[54px] items-center justify-center rounded-full bg-[#25d366] p-1 shadow-[0_14px_34px_rgb(6_42_68_/_28%)] transition duration-300 hover:-translate-y-1 hover:scale-105 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-leehov-blue-300/55 motion-reduce:transition-none sm:right-6 sm:size-[62px] lg:bottom-5"
    >
