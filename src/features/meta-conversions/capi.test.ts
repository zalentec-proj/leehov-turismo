...
describe("payload de Purchase para a Meta", () => {
  it("envia apenas identificadores com hash e dados da compra", () => {
    const payload = buildMetaPurchasePayload({ eventId: "rd_purchase_1", eventTime: "2026-09-02T12:00:00Z", value: 25000, orderId: "deal-1", routeName: "China e Singapura", pixelId: "pixel", contact: { email: "Cliente@Exemplo.com", phone: "11998765432", externalId: "contact-1" } });
